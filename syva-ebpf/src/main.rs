...
use syva_ebpf_common::{
    ...
    SelfTestInodeResult, SelfTestResult, SelfTestUnixResult, ZoneCommKey, ZoneInfoKernel,
    ZonePolicyKernel, DECISION_DENY, DECISION_WOULD_DENY, ENFORCEMENT_COUNTER_ENTRIES, MAX_CGROUPS,
    MAX_EGRESS_CIDRS, MAX_INODES, MAX_ZONES, MAX_ZONE_COMM_PAIRS, MODE_AUDIT,
};
