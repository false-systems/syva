...
# Privileged Linux / BPF-LSM only: proves the enriched deny-event stream —
# zone names, comm, registered path, destination ip:port, reason fields.
