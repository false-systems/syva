...
mod tests {
    ...
    fn render_metrics_includes_agent_gauges() {
        ...
        assert!(output.contains("syva_ebpf_expected_hooks 9\n"));
        assert!(output.contains("syva_ebpf_attached_hooks 9\n"));
    ...
    fn health_json_reports_enforcement_confidence_fields() {
        ...
        assert_eq!(body["expected_hooks"], 9);
        assert_eq!(body["attached_hooks"], 9);
    ...
    #[test]
    fn render_metrics_represents_exactly_nine_supported_hooks() {
        ...
        let hook_attached_series = output
            ...
            .count();
        assert_eq!(hook_attached_series, 9);
